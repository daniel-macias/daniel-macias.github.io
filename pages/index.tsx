...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Daniel Macías | Software Developer</title>
        <meta name="description" content="Daniel Macías builds practical software, creative tools, and products for the web." />
